...
//
	//COAL
	event.addSimpleBlock('#forge:ores/coal', 'minecraft:coal')
	//IRON
	...
	//event.addSimpleBlock('appliedenergistics2:charged_quartz_ore', 'emendatusenigmatica:charged_certus_quartz_chunk')
	//CERTUZ QUARTZ
